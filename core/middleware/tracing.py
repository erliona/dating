...
def get_trace_context(request: web.Request) -> Optional[TraceContext]:
    """Get trace context from request."""
    return request.get('trace_context')


def create_headers_with_trace(request: web.Request, additional_headers: Optional[Dict[str, str]] = None) -> Dict[str, str]:
    """
