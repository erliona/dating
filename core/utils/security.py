...
def validate_telegram_webapp_init_data(
    ...
    Example:
        >>> data = validate_telegram_webapp_init_data(init_data, bot_token)
...
class RateLimiter:
    ...
    def is_allowed(self, user_id: int) -> bool:
        ...
        total_requests = sum(count for _, count in self._storage[user_id])
        ...
        # Add new request
        self._storage[user_id].append((now, 1))
