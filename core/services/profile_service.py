...
from ..models import Education, Gender, Goal, Orientation, UserProfile, UserSettings
...
class ProfileService:
    ...
    async def update_profile(self, user_id: int, **updates) -> Optional[UserProfile]:
        """Update user profile.
    ...
    async def set_visibility(
        self, user_id: int, is_visible: bool
