...
class MatchingService:
    ...
    def calculate_compatibility_score(
        ...
        if profile1.education and profile2.education:
            if profile1.education == profile2.education:
                score += 20
            elif abs(self._education_level(profile1.education) - 
                    self._education_level(profile2.education)) <= 1:
                score += 10
    ...
    def _education_level(self, education) -> int:
        ...
        return education_levels.get(education.value if hasattr(education, 'value') else education, 0)
