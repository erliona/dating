...
down_revision: Union[str, None] = "009b_add_telegram_metadata"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("preferred_gender", sa.String(length=20), nullable=False, server_default="'any'"),
        sa.Column("max_distance_km", sa.Integer(), nullable=False, server_default="50"),
        sa.Column("show_verified_only", sa.Boolean(), nullable=False, server_default="false"),
        sa.Column("show_active_only", sa.Boolean(), nullable=False, server_default="false"),
        ...
        sa.CheckConstraint("max_distance_km >= 1 AND max_distance_km <= 1000", name="valid_max_distance"),
        sa.CheckConstraint("preferred_gender IN ('male', 'female', 'any')", name="valid_preferred_gender"),
    ...
    op.create_table(
        ...
        sa.Column("total_likes_received", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("total_matches", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("daily_superlikes_used", sa.Integer(), nullable=False, server_default="0"),
        ...
        sa.CheckConstraint("daily_superlikes_used >= 0 AND daily_superlikes_used <= 5", name="valid_daily_superlikes"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("user_id"),
    )
    op.create_index("idx_user_activity_user_id", "user_activity", ["user_id"])
    op.create_index("idx_user_activity_last_active", "user_activity", ["last_active_at"])
