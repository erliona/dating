...
down_revision: Union[str, None] = "008b_create_reports_table"
...
def upgrade() -> None:
    ...
    op.add_column("profiles", sa.Column("verification_status", sa.String(length=20), nullable=False, server_default="'none'"))
    op.add_column("profiles", sa.Column("verification_photo_url", sa.String(length=500), nullable=True))
    op.add_column("profiles", sa.Column("verification_requested_at", sa.DateTime(), nullable=True))
    op.add_column("profiles", sa.Column("verification_completed_at", sa.DateTime(), nullable=True))
    op.add_column("profiles", sa.Column("verified_by_admin_id", sa.Integer(), nullable=True))
