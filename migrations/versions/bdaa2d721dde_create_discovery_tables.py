...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("user_id", "target_id", name="unique_user_target_interaction"),
        sa.CheckConstraint("interaction_type IN ('like', 'superlike', 'pass')", name="valid_interaction_type"),
    )
