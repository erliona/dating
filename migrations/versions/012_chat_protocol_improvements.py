...
def upgrade():
    ...
    op.add_column('messages', sa.Column('idempotency_key', postgresql.UUID(), nullable=True))
    op.add_column('messages', sa.Column('idempotency_expires_at', sa.TIMESTAMP(), nullable=True))
    ...
    op.create_table(
        ...
        sa.Column('last_read_at', sa.TIMESTAMP(), nullable=False, server_default=sa.text('NOW()')),
