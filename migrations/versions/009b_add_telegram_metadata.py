...
down_revision: Union[str, None] = "009_add_verification_fields"
...
def upgrade() -> None:
    ...
    op.add_column("users", sa.Column("tg_first_name", sa.String(length=255), nullable=True))
    op.add_column("users", sa.Column("tg_last_name", sa.String(length=255), nullable=True))
    op.add_column("users", sa.Column("tg_language_code", sa.String(length=10), nullable=True))
    op.add_column("users", sa.Column("tg_is_premium", sa.Boolean(), nullable=False, server_default="false"))
    op.add_column("users", sa.Column("tg_photo_url", sa.String(length=500), nullable=True))
    op.add_column("users", sa.Column("tg_bio", sa.Text(), nullable=True))
    
    # Device & Location Info
    op.add_column("users", sa.Column("tg_platform", sa.String(length=50), nullable=True))
    ...
    op.add_column("users", sa.Column("ip_country", sa.String(length=100), nullable=True))
    ...
    # Anti-Fraud Metadata
    op.add_column("users", sa.Column("tg_account_created_at", sa.DateTime(), nullable=True))
    op.add_column("users", sa.Column("tg_has_phone", sa.Boolean(), nullable=False, server_default="false"))
    op.add_column("users", sa.Column("tg_has_username", sa.Boolean(), nullable=False, server_default="false"))
    op.add_column("users", sa.Column("tg_is_bot", sa.Boolean(), nullable=False, server_default="false"))
    op.add_column("users", sa.Column("tg_is_scam", sa.Boolean(), nullable=False, server_default="false"))
    op.add_column("users", sa.Column("tg_is_fake", sa.Boolean(), nullable=False, server_default="false"))
    op.add_column("users", sa.Column("tg_is_verified", sa.Boolean(), nullable=False, server_default="false"))
    op.add_column("users", sa.Column("tg_added_to_attachment_menu", sa.Boolean(), nullable=False, server_default="false"))
    
    # Referral & UTM
    op.add_column("users", sa.Column("referral_source", sa.String(length=100), nullable=True))
    op.add_column("users", sa.Column("referral_campaign", sa.String(length=100), nullable=True))
    ...
    op.add_column("users", sa.Column("is_flagged_for_review", sa.Boolean(), nullable=False, server_default="false"))
    
    # Timestamps
    op.add_column("users", sa.Column("first_login_at", sa.DateTime(), nullable=True))
    op.add_column("users", sa.Column("last_login_at", sa.DateTime(), nullable=True))
    op.add_column("users", sa.Column("registration_completed_at", sa.DateTime(), nullable=True))
