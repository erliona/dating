...
down_revision: Union[str, None] = "008_create_notifications_table"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("context", sa.String(length=20), nullable=False, server_default="'profile'"),
        ...
        sa.UniqueConstraint("reporter_id", "reported_user_id", "context", "context_id", name="unique_report"),
    )
