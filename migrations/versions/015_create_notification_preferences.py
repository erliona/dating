...
def upgrade():
    ...
    op.create_index('idx_notification_preferences_push', 'notification_preferences', ['push_enabled'])
    op.create_index('idx_notification_preferences_telegram', 'notification_preferences', ['telegram_enabled'])
