...
class TestMutualOrientationFiltering:
    ...
    async def test_orientation_filter_query_construction(self):
        ...
        assert "profiles.gender = 'female'" in query_str or "profiles.gender = :gender" in query_str, \
        ...
        assert "profiles.orientation" in query_str, \
        ...
        assert "profiles.user_id !=" in query_str or "profiles.user_id != :user_id" in query_str
