...
class TestFindCandidates:
    ...
    async def test_find_candidates_with_pagination(self):
        ...
        profiles = [
            Profile(id=2, user_id=2, name="P2", birth_date=date(1995, 1, 1),
                   gender="female", orientation="male", goal="dating",
                   is_visible=True, is_complete=True),
            Profile(id=3, user_id=3, name="P3", birth_date=date(1996, 1, 1),
                   gender="female", orientation="male", goal="dating",
                   is_visible=True, is_complete=True)
        ]
...
class TestMatches:
    ...
    async def test_get_matches(self):
        ...
        profile2 = Profile(
            id=2, user_id=2, name="User 2", birth_date=date(1995, 1, 1),
            gender="female", orientation="male", goal="dating",
            is_visible=True, is_complete=True
        )
        profile3 = Profile(
            id=3, user_id=3, name="User 3", birth_date=date(1996, 1, 1),
            gender="female", orientation="male", goal="dating",
            is_visible=True, is_complete=True
        )
        ...
        assert all(isinstance(m[0], Match) and isinstance(m[1], Profile) for m in matches)
...
class TestFavorites:
    ...
    async def test_get_favorites(self):
        ...
        assert all(isinstance(f[0], Favorite) and isinstance(f[1], Profile) for f in favorites)
