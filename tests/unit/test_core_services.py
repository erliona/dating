...
class TestMatchingService:
    ...
    def test_mutual_orientation_compatibility_homosexual(self):
        ...
        # Male seeking male
        user1 = {"gender": Gender.MALE, "orientation": Orientation.MALE}  # Seeks males
        # Male seeking male
        user2 = {"gender": Gender.MALE, "orientation": Orientation.MALE}  # Seeks males
    ...
    def test_mutual_orientation_compatibility_bisexual(self):
        ...
        # Bisexual (seeks any)
        user1 = {"gender": Gender.MALE, "orientation": Orientation.ANY}  # Seeks any
        # Female seeking male
        user2 = {
            "gender": Gender.FEMALE,
            "orientation": Orientation.MALE,  # Seeks males
...
class TestLocationService:
    ...
    def test_location_validation(self):
        ...
        valid_location = {"latitude": 55.7558, "longitude": 37.6173, "city": "Moscow"}
