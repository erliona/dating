...
from core.models.enums import Gender, Orientation, Goal, Education
...
class MockProfileRepository:
    ...
    async def search_profiles(self, user_id: int, settings: UserSettings, limit: int = 10, offset: int = 0):
...
def test_core_independence():
    ...
    from core.models import User, UserProfile, UserSettings
    from core.services import UserService, ProfileService, MatchingService
    from core.interfaces import IUserRepository, IProfileRepository
