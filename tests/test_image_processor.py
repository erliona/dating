...
class TestImageProcessor:
    ...
    def create_test_image(
        self, width: int = 100, height: int = 100, format: str = "JPEG"
    ) -> bytes:
        """Create a test image."""
    ...
    def test_thumbnail_creation(self):
        ...
        image_data = self.create_test_image(800, 600)
        processed_data, thumbnail_data = self.processor.process_image(
            image_data, create_thumbnail=True
        )
    ...
    def test_no_thumbnail(self):
        ...
        image_data = self.create_test_image(800, 600)
        processed_data, thumbnail_data = self.processor.process_image(
            image_data, create_thumbnail=False
        )
