...
- Защита от CSRF атак
- **JWT Middleware защита** - все микросервисы защищены
- **Admin аутентификация** - отдельная система для администраторов
- **PyJWT + bcrypt** - современные алгоритмы безопасности
