...
Мониторинг интегрирован и запускается автоматически.
...
- Бизнес-метрики (регистрации, матчи, лайки)
...
- **Business Metrics** - регистрации, матчи, активность
- **System Overview** - CPU, Memory, Disk, Network
- **Application Logs** - централизованные логи
...
Уведомления можно настроить в Grafana (Settings → Notification channels).
