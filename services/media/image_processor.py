...
class ImageProcessor:
    ...
    def process_image(
        self, image_data: bytes, create_thumbnail: bool = True
        ...
        try:
            ...
            if image.mode in ("RGBA", "LA", "P"):
                ...
                background.paste(
                    image_rgba,
                    mask=image_rgba.split()[-1] if image_rgba.mode == "RGBA" else None,
                )
            ...
            # Optimize main image
            processed_data = self._optimize_image(processed_image)
