...
class ModerationQueue(Base):  # type: ignore[misc,valid-type]
    ...
    def create_photo_moderation(
        cls, photo_id: str, user_id: str, reason: str = "upload", priority: int = 1
    ) -> ModerationQueue:
    ...
    def create_profile_moderation(
        cls, user_id: str, reason: str = "verification", priority: int = 1
    ) -> ModerationQueue:
